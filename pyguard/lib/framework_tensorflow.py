...
TENSORFLOW_RULES = [
    ...
    Rule(
        id="TF004",
        name="Custom Layer Vulnerabilities",
    ...
    Rule(
        id="TF007",
        name="Dataset Pipeline Injection",
    ...
    Rule(
        id="TF008",
        name="Distributed Training Security",
    ...
    Rule(
        id="TF009",
        name="Model Serving Vulnerabilities",
    ...
    Rule(
        id="TF012",
        name="Eager Execution Injection",
    ...
    Rule(
        id="TF014",
        name="Mixed Precision Vulnerabilities",
    ...
    Rule(
        id="TF016",
        name="Model Optimization Tampering",
    ...
    Rule(
        id="TF019",
        name="Knowledge Distillation Risks",
