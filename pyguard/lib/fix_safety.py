...
class FixSafetyClassifier:
    ...
    def _initialize_classifications(self) -> None:
        ...
        self._add_safe_fix(
            ...
            "style",
            "Break long lines",
            "Formatting change preserving semantics"
        )
        ...
        self._add_unsafe_fix(
            ...
            "Changes function signature and behavior. "
            "Requires adding initialization code."
        )
        ...
        self._add_warning_only_fix(
            ...
            "Requires complete redesign of affected code."
        )
