...
"""
        ...
        try:
            ...
            auto_fixable_after = [
                v for v in violations_after if v.fix_applicability.value == "automatic"
            ]
...
"""
        ...
        try:
            ...
            cont_violations_before = [
                v for v in violations_before if v.rule_id in ["E121", "E122", "E128"]
            ]
            ...
            violations_after = checker.check_file(path)
            cont_violations_after = [
                v for v in violations_after if v.rule_id in ["E121", "E122", "E128"]
            ]
...
"""
        ...
        try:
            ...
            comparison_violations = [v for v in violations if v.rule_id in ["E711", "E712", "E722"]]
...
"""
        ...
        try:
            ...
            lambda_name_violations = [
                v for v in violations if v.rule_id in ["E731", "E741", "E742", "E743"]
            ]
...
"""
        ...
        try:
            ...
            assert (
                "reserved" in w606_violations[0].message.lower()
                or "keyword" in w606_violations[0].message.lower()
            )
        finally:
            path.unlink()
...
"""
        ...
        try:
            ...
            deprecation_violations = [
                v for v in violations if v.rule_id in ["W601", "W602", "W603", "W604", "W606"]
            ]
