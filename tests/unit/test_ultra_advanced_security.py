...
class TestSSTIDetector:
    ...
    def test_detect_render_template_string(self):
        ...
        detector = SSTIDetector(['from flask import render_template_string',
    ...
    def test_detect_template_concatenation(self):
        ...
        detector = SSTIDetector(['from jinja2 import Template',
    ...
    def test_safe_template_no_issue(self):
        ...
        detector = SSTIDetector(['from flask import render_template',
